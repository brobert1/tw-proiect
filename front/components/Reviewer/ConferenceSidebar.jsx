...
const ConferenceSidebar = ({ conference }) => {
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-6">
      ...
      <hr className="my-6 border-gray-200" />
      <h3 className="mb-2 text-sm font-semibold text-gray-900">Your Status</h3>
      <p className="text-sm text-gray-600">
        You joined as a reviewer on{' '}
        <span className="font-medium">{formatDate(conference.joined_at)}</span>.
      </p>
    </div>
  );
};
